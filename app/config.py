...
class Settings:
    ...
    # -------------------------------------------------------------------------
    AISENSY_TEMPLATES = {
        "universal_text": os.getenv(
            "AISENSY_TEMPLATE_UNIVERSAL_TEXT", "boradcast_text"
        ),
        "universal_image": os.getenv(
        ...
        "school_otp": os.getenv("AISENSY_TEMPLATE_SCHOOL_OTP", "school_otp"),
        "reminder_english": os.getenv(
            "AISENSY_TEMPLATE_REMINDER_ENGLISH", "reminder_english"
        ),
        "reminder_hindi": os.getenv(
    ...
    AISENSY_BASE_URL = os.getenv(
        "AISENSY_BASE_URL", "https://backend.aisensy.com/campaign/t1/api/v2"
    )

    WORKER_WEBHOOK_SECRET = os.getenv("WORKER_WEBHOOK_SECRET", "")
